...
const Footer = () => {
  ...
  return (
    <div>
      <footer className="bg-gradient-to-r from-[#11998e] via-[#38ef7d] to-[#0fd850] py-8 px-4  rounded-xl mt-20 max-w-7xl mx-auto">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-6">
          <div>
            <div className="flex items-center space-x-2 text-white">
              <span className="text-xl font-bold text-gray-800 dark:text-gray-200 flex gap-2">
                <img src={logo} width="25px" height="25px" alt="" />
                Habit Track
              </span>
            </div>
